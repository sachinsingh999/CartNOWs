    ...
    return (
      <div className="min-h-[70vh] bg-slate-50 dark:bg-slate-950 px-6 py-20 transition-colors duration-200">
        <div className="mx-auto flex max-w-xl flex-col items-center rounded-3xl border border-dashed border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-900/40 backdrop-blur-md p-10 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold text-slate-955 dark:text-slate-100">{t("cart_empty")}</h1>
          <p className="mt-2 max-w-sm text-sm leading-6 text-slate-500 dark:text-slate-455">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_360px]">
              ...
              >
                ...
                <div className="text-left flex flex-col justify-between">
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-2">
                    <span className="rounded-lg border border-slate-200 dark:border-slate-800 px-2.5 py-1 text-xs font-bold text-slate-700 dark:text-slate-350 bg-slate-50/50 dark:bg-slate-950/20">
                      Size: {item.size}
                    </span>
                ...
                <div className="flex items-center justify-between gap-4 sm:flex-col sm:items-end">
                  ...
                  <div className="flex items-center rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 overflow-hidden h-10 shrink-0">
                    <button
                      ...
                      className="indigo-650 h-full flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-850 transition cursor-pointer px-3.5"
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-bold text-red-650 hover:bg-red-50 dark:hover:bg-red-950/20 transition cursor-pointer"
                  >
          ...
          <div className="h-fit rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30 p-6 shadow-sm lg:sticky lg:top-28 text-left space-y-6">
            ...
            <div className="pt-2">
              ...
              <button
                onClick={() => navigate("/product")}
                className="mt-3 w-full rounded-xl border border-slate-200 dark:border-slate-800 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-350 bg-white dark:bg-slate-900/60 hover:bg-slate-50 dark:hover:bg-slate-800 transition cursor-pointer"
              >
                {t("continue_shopping")}
              </button>
            </div>
