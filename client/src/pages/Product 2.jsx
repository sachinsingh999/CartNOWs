  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <section className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 shadow-sm">
        ...
        <div className="mt-10 flex flex-col justify-between gap-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 p-5 shadow-sm md:flex-row md:items-center">
          <div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            <select
              ...
              className="rounded-md border border-gray-300 bg-white dark:bg-slate-900 px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 outline-none transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
            >
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-[300px_1fr]">
          ...
          <div>
            ...
            {displayList.length === 0 && (
              <div className="rounded-lg border border-dashed border-gray-300 bg-white dark:bg-slate-900 p-12 text-center text-gray-500 shadow-sm">
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">No products match these filters.</p>
