  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden z-10 px-6 sm:px-12 lg:px-20 text-center">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center relative z-10">
        ...
        >
          <button className="px-6 py-3 bg-white text-slate-950 font-bold text-xs uppercase tracking-widest transition-all duration-300 hover:bg-slate-100 hover:shadow-lg hover:shadow-white/10 active:scale-[0.98] cursor-pointer flex items-center gap-1.5">
            <span>Start Free Trial</span>
            <ArrowRight size={13} />
          </button>
          <button className="px-6 py-3 bg-transparent hover:bg-white/[0.04] border border-white/20 text-white font-bold text-xs uppercase tracking-widest transition-all duration-300 active:scale-[0.98] cursor-pointer">
            View Live Demo
          </button>
        </motion.div>
      </div>
            ...
            <div className="flex-1 flex items-end gap-3 pt-8 pb-3 select-none">
              {[55, 38, 76, 48, 65, 82, 58, 72, 42, 63, 85, 52, 68, 78, 44].map((h, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 1.1, ease: [0.16, 1, 0.3, 1], delay: i * 0.04 }}
