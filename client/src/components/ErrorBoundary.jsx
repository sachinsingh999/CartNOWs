      ...
      return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-12 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 select-none">
          ...
          <div className="flex flex-wrap gap-3 mt-6 justify-center">
            ...
            <a
              href="/"
              className="px-4.5 py-2.5 bg-slate-100 dark:bg-slate-900 hover:bg-slate-205 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-md text-xs font-black uppercase tracking-wider border border-slate-200/50 dark:border-slate-800 cursor-pointer transition flex items-center gap-1.5 no-underline"
            >
              <Home size={12} />
              <span>Go Home</span>
            </a>
