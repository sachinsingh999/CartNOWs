...
const BenefitsStrip = () => {
  return (
    <section className="w-full px-2 sm:px-4 lg:px-6 py-2 sm:py-3 select-none border-t border-slate-200/50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/10">
