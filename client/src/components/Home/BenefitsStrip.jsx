...
const BenefitsStrip = () => {
  return (
    <section className="w-full px-4 sm:px-12 lg:px-20 py-4 sm:py-8 select-none border-t border-slate-200/50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/10">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
        {[
          ...
          <div key={i} className={`group flex gap-2.5 sm:gap-4 items-center p-3 sm:p-4 rounded-[16px] sm:rounded-[20px] bg-white dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/80 shadow-[0_4px_20px_rgba(0,0,0,0.01)] transition-all duration-300 ${item.bgColor}`}>
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-50 dark:bg-slate-900 rounded-lg sm:rounded-xl flex items-center justify-center shadow-xs border border-slate-100 dark:border-slate-800 shrink-0 group-hover:scale-105 transition-transform duration-300">
