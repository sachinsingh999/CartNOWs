    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 rounded-[32px] p-6 shadow-[0_8px_30px_rgba(0,0,0,0.015)] flex flex-col justify-between min-h-[500px]">
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 py-2 border-b border-slate-100 dark:border-slate-800/80">
          <div className="w-16 h-16 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm shrink-0 bg-slate-50 dark:bg-slate-950">
            <img
          ...
          <div className="leading-tight text-left">
            <h4 className="font-black text-slate-800 dark:text-slate-200 text-base">TechGear Hub Elite</h4>
        ...
        <div className="space-y-3 pt-1">
          <div className="flex justify-between items-center text-[10px] font-bold text-slate-500 dark:text-slate-400">
            ...
            <span className="text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-0.5 rounded-md border border-emerald-100 dark:border-emerald-950/30">99.2%</span>
          </div>
          <div className="flex justify-between items-center text-[10px] font-bold text-slate-500 dark:text-slate-400">
          ...
          <p className="text-[11px] text-slate-600 dark:text-slate-300 leading-relaxed font-bold mt-2">
            About the Seller:
          </p>
      ...
      <button
        ...
        className="w-full mt-4 py-4 bg-slate-900 hover:bg-black dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-100 dark:text-white font-extrabold text-xs uppercase tracking-wider rounded-2xl shadow-md transition cursor-pointer border-none"
      >
        Explore Store
      </button>
    </div>
