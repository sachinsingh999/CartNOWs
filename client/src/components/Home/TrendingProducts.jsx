    ...
    <div className="grid grid-cols-1 lg:grid-cols-[22%_78%] gap-6 lg:gap-8 items-stretch mb-8 select-none text-left">
      ...
      <div className="flex flex-col h-full">
        ...
        <div 
          ...
          className="relative p-5 text-slate-100 dark:text-white flex flex-col justify-between shadow-xl shadow-blue-500/5 dark:shadow-black/50 flex-1 min-h-[390px] h-full text-left border border-slate-800/80"
        >
