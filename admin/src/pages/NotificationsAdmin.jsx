  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">Platform Announcements</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <h2 className="text-sm font-black text-slate-800 tracking-tight">Compose System Announcement</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <button
                  ...
                  className={`py-3 px-4 rounded-xl border text-xs font-bold transition flex flex-col items-center justify-center gap-1 cursor-pointer ${
                    targetRole === "all"
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-xs outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition"
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-800 text-xs outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition resize-none"
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-xl text-xs font-black uppercase tracking-wider transition shadow-md active:scale-95 disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2"
            >
              <Send size={14} />
