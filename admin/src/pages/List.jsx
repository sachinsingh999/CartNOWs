  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 shrink-0">
        {/* Stat 1 */}
        <div className="bg-white dark:bg-[#172033] border border-slate-200/80 dark:border-white/[0.08] rounded-xl p-4 flex items-center gap-4 shadow-xs hover:border-slate-300 dark:hover:border-slate-700/85 transition duration-200">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-white/[0.08] text-slate-605 dark:text-slate-300">
            <Box size={16} />
          </div>
          <div>
        ...
        {/* Stat 2 */}
        <div className="bg-white dark:bg-[#172033] border border-slate-200/80 dark:border-white/[0.08] rounded-xl p-4 flex items-center gap-4 shadow-xs hover:border-slate-300 dark:hover:border-slate-700/85 transition duration-200">
          <div className={`flex h-9 w-9 items-center justify-center rounded-lg border ${outOfStock > 0 ? "bg-rose-500/10 border-rose-500/20 text-rose-500" : "bg-slate-100 dark:bg-slate-900 border-slate-200 dark:border-white/[0.08] text-slate-605 dark:text-slate-300"}`}>
      ...
      <div className="sticky top-[-20px] z-10 bg-slate-50/90 dark:bg-[#0B1220]/90 backdrop-blur-xs py-3.5 border-b border-slate-200/60 dark:border-white/[0.05]">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-200/80 dark:border-white/[0.08] bg-white dark:bg-[#172033] text-slate-900 dark:text-white text-xs outline-none transition focus:border-blue-600 dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 font-semibold placeholder:text-slate-400 dark:placeholder:text-slate-500"
          />
        </div>
      </div>
      ...
      <div className="grid gap-4.5">
        {filteredList.length === 0 ? (
          <div className="rounded-xl border border-slate-200/85 dark:border-white/[0.08] bg-white dark:bg-[#172033] py-16 text-center text-xs text-slate-500 dark:text-slate-400 shadow-xs flex flex-col items-center justify-center gap-3">
            ...
            <div>
              <p className="font-bold text-slate-805 dark:text-slate-200">No products match your search</p>
              <p className="text-slate-400 dark:text-slate-550 mt-1">Try adjusting your filters or search keywords.</p>
            </div>
          </div>
        ) : (
          filteredList.map((item) => (
            <div
              key={item._id}
              className="bg-white dark:bg-[#172033] rounded-xl border border-slate-200/80 dark:border-white/[0.08] p-4.5 shadow-xs hover:border-slate-300 dark:hover:border-slate-700/80 transition duration-200 flex flex-col sm:flex-row items-center sm:items-stretch gap-5"
            >
              {/* Product Image */}
              ...
              <div className="flex-1 min-w-0 flex flex-col justify-between text-center sm:text-left">
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap justify-center sm:justify-start gap-1.5">
                    ...
                    <span className="rounded bg-slate-100 dark:bg-slate-900 px-2 py-0.5 text-[9px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider border border-slate-250 dark:border-white/[0.06]">
                      {item.category}
                    </span>
                    {item.subCategory && (
                      <span className="rounded bg-slate-100 dark:bg-slate-900 px-2 py-0.5 text-[9px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider border border-slate-250 dark:border-white/[0.06]">
              ...
              <div className="flex-1 space-y-1.5 text-[11px] text-slate-500 dark:text-slate-400 flex flex-col justify-center border-y border-slate-100 dark:border-white/[0.04] sm:border-y-0 py-3 sm:py-0 font-medium">
                <p><span className="font-bold text-slate-400 dark:text-slate-500 uppercase text-[8px] tracking-widest block mb-0.5">Brand</span> <span className="text-slate-800 dark:text-slate-205 font-bold">{item.brand || "—"}</span></p>
                <p><span className="font-bold text-slate-400 dark:text-slate-500 uppercase text-[8px] tracking-widest block mb-0.5">SKU</span> <span className="text-slate-800 dark:text-slate-205 font-mono font-bold">{item.sku || "—"}</span></p>
                <p>
              ...
              <div className="flex flex-col justify-center text-center sm:text-left min-w-[120px] shrink-0 border-l border-slate-100 dark:border-white/[0.06] pl-4">
                <span className="text-[9px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-widest block">Unit Price</span>
