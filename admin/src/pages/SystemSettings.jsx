...
import { Sliders, ShieldAlert, Cpu, Mail, Phone, Clock, FileImage, Shield, Check, Eye } from "lucide-react";
...
const SystemSettings = ({ token }) => {
  ...
  return (
    <div className="space-y-6 text-left animate-fadeIn">
        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 pb-3.5 text-xs font-black uppercase tracking-wider transition-all relative border-b-2 -mb-[2px] cursor-pointer ${
                isSelected
      ...
      {/* Main Settings Body */}
      <div className="bg-white/95 dark:bg-[#151b26]/95 border border-slate-200/60 dark:border-slate-800/80 rounded-[28px] p-6 sm:p-8 shadow-sm">
        
        {/* ── MAINTENANCE MODE PANEL ── */}
        {activeTab === "maintenance" && (
          <form onSubmit={handleSaveMaintenance} className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-slate-55/30 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800">
              ...
              <button
                ...
                className={`w-14 h-8 flex items-center rounded-full p-1 cursor-pointer transition-all duration-300 ${
                  enabled ? "bg-red-500 justify-end" : "bg-slate-300 dark:bg-slate-700 justify-start"
                }`}
              >
                <span className="h-6 w-6 rounded-full bg-white shadow-md transform transition duration-300" />
              </button>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-[#0B1220] text-slate-800 dark:text-white text-xs font-semibold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-[#0B1220] text-slate-800 dark:text-white text-xs font-semibold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-[#0B1220] text-slate-800 dark:text-white text-xs font-semibold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition resize-none"
              />
            </div>
            ...
            <div className="flex justify-end pt-4 border-t border-slate-100 dark:border-slate-800/80">
              <button
                ...
                className="px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all duration-200 active:scale-95 shadow-md flex items-center gap-2 cursor-pointer disabled:opacity-50"
              >
                <Check size={14} />
          ...
          <form onSubmit={handleSaveCommission} className="space-y-6">
            ...
            <div className="flex justify-end pt-4 border-t border-slate-100 dark:border-slate-800/80">
              <button
                ...
                className="px-6 py-3.5 bg-slate-900 dark:bg-slate-800 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all duration-200 active:scale-95 shadow-md flex items-center gap-2 cursor-pointer disabled:opacity-50"
              >
                <Check size={14} />
              ...
              {[
                ...
                <div key={item.id} className="flex items-center justify-between py-4 first:pt-0 last:pb-0 gap-4">
                  ...
                  <button
                    ...
                    className={`w-12 h-7.5 flex items-center rounded-full p-1 cursor-pointer transition-all duration-300 ${
                      item.flag ? "bg-blue-600 justify-end" : "bg-slate-300 dark:bg-slate-700 justify-start"
                    }`}
                  >
                    <span className="h-5.5 w-5.5 rounded-full bg-white shadow-sm transform transition duration-300" />
                  </button>
                </div>
              ))}
            </div>
