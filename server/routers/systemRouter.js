...
import { getHeroAssets, addHeroAsset, updateHeroAsset, deleteHeroAsset, removeHeroAssetBackground, reorderHeroAssets, aiGenerateHeroAssetTitle } from "../controllers/heroAssetController.js";
...
systemRouter.post("/hero-assets/ai-generate-title", adminAuth, requirePermission("promos"), aiGenerateHeroAssetTitle);
