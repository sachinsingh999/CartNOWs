...
const Landing = ({ theme, setTheme }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-[#070A13] text-slate-800 dark:text-slate-100 font-sans selection:bg-blue-600 selection:text-white transition-colors duration-200 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-[#070A13]/70 border-b border-slate-200 dark:border-slate-900 px-6 py-4 transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left leading-none">
              ...
              <span className="text-[10px] text-blue-650 dark:text-indigo-400 font-black uppercase tracking-wider mt-0.5">Courier Hub</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-450 hover:text-slate-900 dark:hover:text-white px-4 py-2.5 rounded-xl transition"
            >
              Sign In
            </button>
            <button 
              onClick={() => navigate("/signup")}
              className="bg-blue-600 hover:bg-blue-700 text-white text-xs font-black uppercase tracking-wider px-5 py-3 rounded-xl transition-all duration-300 shadow-md shadow-blue-500/10 active:scale-98 cursor-pointer"
            >
              Apply Now
            </button>
          </div>
      ...
      <section className="pt-20 pb-16 px-6 relative max-w-7xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-650 dark:text-indigo-400 text-xs font-extrabold uppercase tracking-wider mb-6">
          <Truck size={12} />
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button 
            onClick={() => navigate("/signup")}
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-wider px-8 py-4 rounded-xl transition-all duration-300 shadow-lg shadow-indigo-500/15 active:scale-98 cursor-pointer"
          >
          ...
          <a
            href="#calculator"
            className="w-full sm:w-auto flex items-center justify-center gap-2 border border-slate-250 dark:border-slate-800 bg-white/50 dark:bg-slate-900/30 hover:bg-slate-100 dark:hover:bg-slate-900/60 text-slate-600 dark:text-slate-350 hover:text-slate-900 dark:hover:text-white font-bold px-8 py-4 rounded-xl transition duration-300 shadow-sm"
          >
        ...
        <div className="mt-16 relative rounded-3xl border border-slate-200 dark:border-slate-850 bg-white/80 dark:bg-[#0F1321]/50 p-4 md:p-6 shadow-2xl backdrop-blur-md max-w-4xl mx-auto overflow-hidden text-left">
          <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-850/80 mb-6">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-red-500/80" />
              <span className="w-3 h-3 rounded-full bg-yellow-500/80" />
              <span className="w-3 h-3 rounded-full bg-green-500/80" />
              <span className="text-xs text-slate-450 font-bold ml-2">Courier Console</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/40">
              ...
              <span className="text-2xl font-black text-blue-650 dark:text-indigo-400 block mt-1.5">6 Packages</span>
              <span className="text-[10px] text-slate-500 font-bold mt-1 block">Available in your current zone</span>
            </div>
          </div>

          <div className="border border-slate-200 dark:border-slate-850 bg-slate-50/50 dark:bg-slate-950/20 rounded-2xl p-4">
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={idx} className="flex justify-between items-center text-xs p-3 border border-slate-200 dark:border-slate-850/60 rounded-xl bg-white dark:bg-slate-950/50">
                  <div className="flex flex-col text-left">
                    <span className="font-bold text-slate-800 dark:text-slate-250 truncate">{item.route}</span>
                    <span className="text-[10px] text-slate-450 mt-0.5">{item.dist} • {item.weight}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              return (
                <div 
                  key={idx} 
                  className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F1424]/20 hover:border-slate-350 dark:hover:border-slate-700 hover:shadow transition duration-300 group"
                >
      ...
      <section id="calculator" className="py-24 px-6 relative max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
          ...
          {/* Calculator Card */}
          <div className="p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F1424]/40 shadow-xl backdrop-blur-sm relative overflow-hidden text-left">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center text-xs font-bold text-slate-500 dark:text-slate-450">
                ...
                <span className="text-blue-650 dark:text-indigo-400">{deliveriesPerDay} deliveries</span>
              </div>
              <input
                type="range"
                min="5"
                ...
                className="w-full h-1.5 bg-slate-200 dark:bg-slate-800 rounded-lg appearance-none cursor-pointer accent-blue-650"
              />
            </div>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex justify-between items-center text-xs font-bold text-slate-500 dark:text-slate-450">
                ...
                <span className="text-blue-650 dark:text-indigo-400">${avgTip}</span>
              </div>
              <input
                type="range"
                min="0"
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center md:items-start text-center md:text-left p-6 rounded-2xl bg-white dark:bg-[#0F1424]/20 border border-slate-200 dark:border-slate-850">
                ...
                <p className="mt-3 text-xs leading-relaxed text-slate-550 dark:text-slate-400 font-light">
                  {step.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div 
              key={idx} 
              className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F1424]/20 overflow-hidden transition"
            >
              <button
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`text-slate-450 transition-transform duration-300 ${
              ...
              <div 
                className={`transition-all duration-300 ease-in-out overflow-hidden ${
                  activeFaq === idx ? "max-h-40 border-t border-slate-200 dark:border-slate-800/40" : "max-h-0"
                }`}
              >
      ...
      <footer className="border-t border-slate-200 dark:border-slate-900 bg-slate-50 dark:bg-slate-950/80 py-16 px-6 relative z-10 text-center">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-[#090D1A] flex items-center justify-center">
              <Logo variant="icon" className="h-5 w-5 text-slate-850 dark:text-white" />
            </div>
            <div className="flex flex-col text-left leading-none">
              <span className="text-sm font-black text-slate-900 dark:text-white">CartNOW</span>
              <span className="text-[9px] text-blue-650 dark:text-indigo-400 font-black uppercase tracking-wider mt-0.5">Courier Hub</span>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-slate-200 dark:border-slate-900 w-full max-w-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="text-slate-750 dark:text-slate-700 select-none">•</span>
              <a 
                href="https://cart-now-deliveryagent.vercel.app/" 
                className="text-xs font-bold text-slate-450 hover:text-blue-500 transition"
              >
