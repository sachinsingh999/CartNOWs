...
const SignUp = () => {
    ...
    return (
      <div className="min-h-[100dvh] w-full flex items-center justify-center p-4 bg-slate-950 text-slate-100 font-sans">
        <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl text-center space-y-6">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-emerald-950 bg-emerald-950/50 text-emerald-400 border border-emerald-800/80 shadow-inner">
            <CheckCircle size={28} className="animate-bounce" />
          </div>
          <div>
            <h2 className="text-xl font-extrabold text-slate-100 dark:text-white tracking-tight">Application Received</h2>
          ...
          <Link
            to="/login"
            className="block w-full py-3.5 bg-orange-600 hover:bg-orange-700 hover:bg-orange-700 text-slate-100 dark:text-white rounded-xl text-xs font-black uppercase tracking-wider transition shadow-md cursor-pointer"
          >
            Return to Sign In
          </Link>
        </div>
  ...
  return (
    <div className="min-h-[100dvh] w-full grid lg:grid-cols-[1.1fr_1fr] bg-slate-950 text-slate-100 font-sans selection:bg-orange-500 selection:text-white lg:h-screen lg:overflow-hidden">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-8 overflow-hidden h-full">
        ...
        <div className="relative z-20 mt-auto text-left max-w-xl">
          ...
          <h2 className="text-3xl font-black text-slate-100 dark:text-white leading-tight">
            Launch your digital store storefront today.
          </h2>
          <p className="mt-3 text-xs leading-relaxed text-slate-400 text-slate-400 font-light">
          ...
          <div className="mt-6 pt-5 border-t border-slate-800/80 flex items-center gap-6">
            ...
            <div className="text-[11px] text-slate-400 font-medium">
              Join <span className="text-slate-100 dark:text-white font-extrabold">10,000+ business owners</span> worldwide.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm space-y-5 my-auto">
          ...
          <div className="flex flex-col items-center text-center space-y-1.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 text-slate-400">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-2.5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-orange-600 hover:bg-orange-700 text-slate-100 dark:text-white py-3 text-xs font-black uppercase tracking-wider transition duration-300 shadow-md hover:shadow-lg hover:shadow-orange-500/20 active:scale-[0.98] cursor-pointer mt-3 disabled:opacity-50"
            >
