...
import { Store, Mail, Lock, User, Phone, CheckCircle, Eye, EyeOff } from "lucide-react";
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950">
        <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl text-center space-y-5">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-emerald-950/50 text-emerald-400 border border-emerald-800/80 shadow-inner">
            <CheckCircle size={28} className="animate-bounce" />
          </div>
          <div>
            <h2 className="text-xl font-extrabold text-white tracking-tight">Application Submitted</h2>
            <p className="text-xs text-slate-400 mt-2 leading-relaxed">
              Your application to become a seller partner has been successfully received and is currently under review.
            </p>
            <div className="mt-4 p-3 bg-slate-950/50 rounded-xl border border-slate-800/80 text-[11px] font-semibold text-slate-400">
              Please contact the store administrator or check your email for approval updates before signing in.
            </div>
          </div>
          <Link
            to="/login"
            className="block w-full py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition shadow-sm select-none"
          >
            Return to Sign In
          </Link>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl space-y-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Start selling your products. Register your shop below.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={onSubmitHandler} className="space-y-4">
          <div>
            <label className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-400">Shop Name</label>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-800 bg-slate-950/40 text-sm text-white outline-none transition duration-200 placeholder:text-slate-655 focus:bg-slate-950/80 focus:border-orange-550 focus:ring-4 focus:ring-orange-550/10"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-11 py-3.5 rounded-xl border border-slate-800 bg-slate-950/40 text-sm text-white outline-none transition duration-200 placeholder:text-slate-655 focus:bg-slate-950/80 focus:border-orange-550 focus:ring-4 focus:ring-orange-550/10"
                required
              />
              <button
                type="button"
        ...
        <div className="text-center pt-4 border-t border-slate-800/80">
          <Link to="/login" className="text-xs font-bold text-slate-400 hover:text-white transition underline">
