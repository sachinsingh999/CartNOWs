...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-orange-500 selection:text-white relative overflow-hidden">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 backdrop-blur-md bg-slate-950/70 border-b border-slate-900 px-6 py-4 transition-all">
      ...
      <section className="pt-20 pb-16 px-6 relative max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-slate-100 dark:text-white max-w-4xl mx-auto leading-[1.1]">
        ...
        <div className="mt-16 relative rounded-2xl border border-slate-800 bg-slate-900/40 p-4 md:p-6 shadow-2xl backdrop-blur-sm max-w-5xl mx-auto overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left relative z-0">
            <div className="p-5 rounded-xl border border-slate-800/50 bg-slate-900/20">
              ...
              <div className="text-2xl font-black text-slate-100 dark:text-white">$24,850.00</div>
            ...
            <div className="p-5 rounded-xl border border-slate-800/50 bg-slate-900/20">
              ...
              <div className="text-2xl font-black text-slate-100 dark:text-white">412 Orders</div>
              <div className="text-[10px] text-emerald-400 font-bold mt-1 flex items-center gap-1">
                <span>↑ +8.2%</span>
            ...
            <div className="p-5 rounded-xl border border-slate-800/50 bg-slate-900/20">
              ...
              <div className="text-2xl font-black text-slate-100 dark:text-white">4.92 / 5.00</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              return (
                <div 
                  key={idx} 
                  className="p-6 rounded-2xl border border-slate-800/80 bg-slate-900/20 hover:border-slate-700/80 hover:bg-slate-900/40 transition-all duration-300 group"
                >
      ...
      <section id="calculator" className="py-24 px-6 relative max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
          ...
          {/* Calculator Card */}
          <div className="p-6 sm:p-8 rounded-3xl border border-slate-800 bg-slate-900/40 shadow-xl backdrop-blur-sm relative overflow-hidden text-left">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {[
              ...
              <div key={i} className="flex flex-col items-center md:items-start text-center md:text-left relative p-6 rounded-2xl bg-slate-900/20 border border-slate-900">
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto">
        <h2 className="text-3xl font-extrabold text-center text-slate-100 dark:text-white mb-12">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div 
              key={idx} 
              className="rounded-2xl border border-slate-800/80 bg-slate-900/20 overflow-hidden transition"
            >
              <button
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`text-slate-400 transition-transform duration-300 ${ activeFaq === idx ? "transform rotate-180 text-orange-500" : "" }`}
                />
              </button>
              
              <div 
                className={`transition-all duration-300 ease-in-out overflow-hidden ${ activeFaq === idx ? "max-h-40 border-t border-slate-800/40" : "max-h-0" }`}
              >
