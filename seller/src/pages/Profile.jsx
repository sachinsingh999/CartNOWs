    ...
    <div className="space-y-4 animate-fadeIn text-slate-800 dark:text-slate-100">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-xs space-y-3.5 shrink-0">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
              <ShieldCheck size={12} />
              Verified Storefront
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 rounded-2xl p-5 text-white shadow-xs relative overflow-hidden text-left space-y-4">
          ...
          {/* Quick Info Tip */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-xs space-y-2 text-left">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Shop Details form */}
          <form onSubmit={handleProfileSubmit} className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-xs space-y-4 text-left">
            <div className="pb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  disabled
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 text-slate-400 text-xs font-semibold outline-none cursor-not-allowed"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white text-xs font-semibold outline-none transition focus:ring-1 focus:ring-orange-500"
                  required
                />
              </div>
            </div>
          ...
          <form onSubmit={handlePasswordSubmit} className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-xs space-y-4 text-left">
            <div className="pb-3">
              <h3 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white text-xs font-semibold outline-none transition focus:ring-1 focus:ring-slate-700"
                  required
                />
              </div>
