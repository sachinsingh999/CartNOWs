  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-2xl font-black text-slate-900 mt-1">{visitorCount.toLocaleString()}</p>
            </div>
            <div className="h-10 w-10 bg-[#FF5100]/10 text-[#FF5100] rounded-xl flex items-center justify-center border border-[#FF5100]/20">
              <Users size={18} />
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-2xl font-black text-slate-900 mt-1">{pageViews.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
          <div className="flex justify-between items-start">
            ...
            <div className="h-10 w-10 bg-violet-50 text-violet-650 rounded-xl flex items-center justify-center border border-violet-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Traffic Chart */}
        <div className="lg:col-span-2 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-6 flex flex-col justify-between">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div>
              <h3 className="text-base font-extrabold text-slate-900 tracking-tight">Weekly Store Traffic</h3>
              <p className="text-[11px] text-slate-400">Total number of unique visitor requests over the past 7 days.</p>
            </div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider bg-slate-50 border border-slate-100 px-3 py-1 rounded-full">
              Live Monitor
            </span>
          </div>
          ...
          <div className="relative pt-6 px-2">
            ...
            {hoveredTraffic !== null && (
              <div 
                className="absolute bg-slate-950 text-white rounded-xl px-3.5 py-2 text-left shadow-xl border border-slate-800 pointer-events-none z-10 transition-all duration-150"
                style={{
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-4">
          <h3 className="text-base font-extrabold text-slate-900 tracking-tight">Catalog Metrics</h3>
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-1">
              ...
              <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                <div className="bg-indigo-650 bg-indigo-600 h-full w-[80%]" />
              </div>
            </div>
            <div className="space-y-1">
              <div className="flex justify-between text-xs text-slate-700 font-bold">
